...
export default function Movies() {
  ...
  return (
    <div className="flex flex-row items-center bg-black m-0 gap-40">

      <div className=" pl-10">
        <p className="font-single-day text-left text-6xl text-[#72DB73]">Super app</p><br /><br /><br /><br /><br />
        <p className="text-white font-semibold text-5xl">Choose your entertainment <br />category</p>
